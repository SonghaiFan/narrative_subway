...
export function TopicAnalysis({ events = [] }: TopicAnalysisProps) {
  ...
  const sortedTopics = Array.from(topicMap.values()).sort(
    (a, b) => b.frequency - a.frequency
  );

  return (
    <div className="p-6 h-full flex flex-col overflow-auto">
      <h2 className="text-lg font-bold mb-4">Topic Analysis</h2>
      <div className="space-y-6">
        <div>
          <h3 className="font-medium mb-2">
            Topic Distribution ({topicMap.size} unique topics)
          </h3>
